  ...
  return (
    <div className={styles.welcomeScreen_wrapper}>
      <div className={styles.welcomeScreen_header}>
        ...
        <div>
          <SiBento color="#6B7280" />
        </div>
      </div>
      <div className={styles.welcomeScreen_body}>
        <div className={styles.welcomeScreen_image}></div>
        ...
        <div className={styles.welcomeScreen_button}>
          <button className={styles.cookButton}>Let's cook! 🍳</button>
          <span className={styles.button_description}>
            Press <span className={styles.enter}>enter</span> to manifest
          </span>
        </div>
      </div>
